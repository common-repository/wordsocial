...
class WSO_LinkedIn extends WSO_Service
{
	...
	public function connect()
	{
		...
		$this->m_linkedIn->setCallbackUrl(get_bloginfo('wpurl')."/wp-admin/options-general.php?page=".WSO_PLUGIN_HOOK."&connect=li&resp=1");
	...
	{	
		...
		{	
			...
			echo '<p><a href="options-general.php?page='.WSO_PLUGIN_HOOK.'&connect=li"><img height="21" width="133" src="'. WSO_IMAGES_FOLDER .'signin-linkedin.png" alt="signin linkedin" /></a></p>';
		}
		else
		{
...
?>
<p><?php _e('Hello', 'wordsocial'); ?> <strong><?php echo $user; ?></strong>. <a href="options-general.php?page=<?php echo WSO_PLUGIN_HOOK; ?>&disconnect=li">[<?php _e('Disconnect', 'wordsocial'); ?>]</a></p>
